...
file_location = "/mnt/app-mailpoint/"
mount = '/dbfs'
zona_crudos = '/raw/'
zona_result = '/results/'
name_panel = 'panel_'
data_base = 'mailpoint'
name_table = 'Zdr_'
tabla_metadatos = 'mailpoint.zdr_mailpoint_src_metadatos_inventario_tablas_bd'
tabla_indices = 'mailpoint.zdr_mailpoint_src_metadatos'
...
"""
Descripción: Llama todos los metodo para el funcionamiento correcto de la aplicacion mailpoint
