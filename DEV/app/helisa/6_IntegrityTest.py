...
# Rutas
path_lectura = '/mnt/app-helisa/' + subapplication + '/raw/'
path_escritura = '/mnt/app-helisa-storage/' + subapplication 
# Eliminar archivo de propiedades existente
dbutils.fs.rm('/dbfs' + path_escritura + 'propiedades_helisa_csv_db.txt', True)
# Generacion archivo de propiedades
with open('/dbfs' + path_escritura + '/propiedades_helisa_csv_db.txt', 'w') as f:
...
path_escritura = '/mnt/app-helisa-storage/' + subapplication + '/'
# Generacion archivo de propiedades
with open('/dbfs' + path_escritura + '/propiedades_helisa_anexos_db.txt', 'w') as f:
  f.write('carpeta|md5\r\n')
  print('carpeta|md5')
#   for i in os.listdir('/dbfs'+path_lectura):
#     if i.endswith(".zip"):
