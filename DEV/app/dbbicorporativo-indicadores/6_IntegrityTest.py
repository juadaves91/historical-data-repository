...
# Rutas
path_lectura = '/mnt/dbbicorporativo-indicadores/raw/'
path_escritura = '/mnt/dbbicorporativo-indicadores-storage/'
# Eliminar archivo de propiedades existente
dbutils.fs.rm('/dbfs'+path_escritura+'propiedades_dbbicorporativo_csv_db.txt', True)
# Generacion archivo de propiedades
with open('/dbfs'+path_escritura+'/propiedades_dbbicorporativo_csv_db.txt', 'w') as f:
...
# Definición de Rutas
path_lectura = '/mnt/dbbicorporativo-indicadores-storage/'
path_escritura = '/mnt/dbbicorporativo-indicadores-storage/'
# Eliminar archivo de propiedades existente
dbutils.fs.rm('/dbfs'+path_escritura+'propiedades_dbbicorporativo_anexos_db.txt', True)
# Generacion archivo de propiedades
with open('/dbfs'+path_escritura+'/propiedades_dbbicorporativo_anexos_db.txt', 'w') as f:
  f.write('carpeta|md5\r\n')
  print('carpeta|md5')
  for i in os.listdir('/dbfs'+path_lectura):
    if i.endswith(".zip"):
