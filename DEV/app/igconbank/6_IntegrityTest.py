...
# Rutas
path_lectura = '/mnt/app-igconbank/' + subapplication + '/raw/'
path_escritura = '/mnt/app-igconbank-storage/' + subapplication 
# Eliminar archivo de propiedades existente
dbutils.fs.rm('/dbfs' + path_escritura + 'propiedades_igconbank_csv_db.txt', True)
# Generacion archivo de propiedades
with open('/dbfs' + path_escritura + '/propiedades_igconbank_csv_db.txt', 'w') as f:
...
path_escritura = '/mnt/app-igconbank-storage/' + subapplication + '/'
# Generacion archivo de propiedades
with open('/dbfs' + path_escritura + '/propiedades_igconbank_anexos_db.txt', 'w') as f:
  f.write('carpeta|md5\r\n')
  print('carpeta|md5')
#   for i in os.listdir('/dbfs'+path_lectura):
#     if i.endswith(".zip"):
